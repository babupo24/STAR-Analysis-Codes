...
void integratedSignalAsym_Minv_5bins(const char *ifile="/star/u/pokhrel/GPFS/IFF_TREES/StartLessTOF/iffNtuplesFinal.root")
{
        gStyle->SetOptFit(0);
        gStyle->SetOptStat(0);
...
//print values in table format
 ...
 gr_BkgTofGt->GetYaxis()->SetRangeUser(-0.005,0.04);
