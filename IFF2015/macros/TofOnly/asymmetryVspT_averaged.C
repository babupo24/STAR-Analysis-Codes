...
void asymmetryVspT_averaged(const char *ifile="/star/u/pokhrel/GPFS/IFF_TREES/StartLessTOF/iffNtuplesFinalA.root")
{
	...
	Output.open("AsymVspTTOFonly.txt");
	float eta_pair;
	float fspinconfig;
	float cone;
	float pT_pair;
	...
	Int_t nentries = (Int_t)ntuple1tof->GetEntries(); //entries of trees 
	...
	for(Int_t mbin=0;mbin<5;mbin++)
	{
		...
		fitCanvas[mbin]->Print(Form("FitPlots_Mbin_%i_AsymVspTTOFonly.pdf(", mbin));
		...
		for(int m=0;m<9;m++)
		{
			...
			//sprintf(name,"Minv%i_pTbin%i_etaGt_BLUETOFonly.pdf",mbin, m);
			//c1->SaveAs(name);
			fitCanvas[mbin]->Print(Form("FitPlots_Mbin_%i_AsymVspTTOFonly.pdf", mbin));
...
for(int j=0; j<5; j++){
	ofstream altout;
	agtout.open(Form("AutVspTTofOnlyGt_M%i.txt", j));
	for(int i=0; i<9; i++){
		agtout<<WavgA_pT1g[i]<<"\t"<<WerrA_pT1g[i]<<endl;
	}
	agtout.close();
}
...
for(int j=0; j<5; j++){
	ofstream altout;	
	altout.open(Form("AutVspTTofOnlyLt_M%i.txt", j));
	for(int i=0; i<9; i++){
		altout<<WavgA_pT1l[i]<<"\t"<<WerrA_pT1l[i]<<endl;
	}
	altout.close();
}
  ...
  Output<< "double A_pTgt1[9] ={"<<WavgA_pT1l[0]<<", "<<WavgA_pT1l[1]<<", "<<WavgA_pT1l[2]<<", "<<WavgA_pT1l[3]<<", "<<WavgA_pT1l[4]<<", "<<WavgA_pT1l[5]<<", "<<WavgA_pT1l[6]<<", "<<WavgA_pT1l[7]<<", "<<WavgA_pT1l[8]<<"}"<<endl;
  Output<< "double AWerr_pTgt1[9]={"<<WerrA_pT1l[0]<<", "<<WerrA_pT1l[1]<<", "<<WerrA_pT1l[2]<<", "<<WerrA_pT1l[3]<<", "<<WerrA_pT1l[4]<<", "<<WerrA_pT1l[5]<<", "<<WerrA_pT1l[6]<<", "<<WerrA_pT1l[7]<<", "<<WerrA_pT1l[8]<<"}"<<endl;
  Output<< "double A_pTgt2[9]={"<<WavgA_pT2l[0]<<", "<<WavgA_pT2l[1]<<", "<<WavgA_pT2l[2]<<", "<<WavgA_pT2l[3]<<", "<<WavgA_pT2l[4]<<", "<<WavgA_pT2l[5]<<", "<<WavgA_pT2l[6]<<", "<<WavgA_pT2l[7]<<", "<<WavgA_pT2l[8]<<"}"<<endl;
  Output<< "double AWerr_pTgt2[9]={"<<WerrA_pT2l[0]<<", "<<WerrA_pT2l[1]<<", "<<WerrA_pT2l[2]<<", "<<WerrA_pT2l[3]<<", "<<WerrA_pT2l[4]<<", "<<WerrA_pT2l[5]<<", "<<WerrA_pT2l[6]<<", "<<WerrA_pT2l[7]<<", "<<WerrA_pT2l[8]<<"}"<<endl;
  Output<< "double A_pTgt3[9] ={"<<WavgA_pT3l[0]<<", "<<WavgA_pT3l[1]<<", "<<WavgA_pT3l[2]<<", "<<WavgA_pT3l[3]<<", "<<WavgA_pT3l[4]<<", "<<WavgA_pT3l[5]<<", "<<WavgA_pT3l[6]<<", "<<WavgA_pT3l[7]<<", "<<WavgA_pT3l[8]<<"}"<<endl;
  Output<< "double AWerr_pTgt3[9] ={"<<WerrA_pT3l[0]<<", "<<WerrA_pT3l[1]<<", "<<WerrA_pT3l[2]<<", "<<WerrA_pT3l[3]<<", "<<WerrA_pT3l[4]<<", "<<WerrA_pT3l[5]<<", "<<WerrA_pT3l[6]<<", "<<WerrA_pT3l[7]<<", "<<WerrA_pT3l[8]<<"}"<<endl;
  Output<< "double A_pTgt4[9] ={"<<WavgA_pT4l[0]<<", "<<WavgA_pT4l[1]<<", "<<WavgA_pT4l[2]<<", "<<WavgA_pT4l[3]<<", "<<WavgA_pT4l[4]<<", "<<WavgA_pT4l[5]<<", "<<WavgA_pT4l[6]<<", "<<WavgA_pT4l[7]<<", "<<WavgA_pT4l[8]<<"}"<<endl;
  Output<< "double AWerr_pTgt4[9] ={"<<WerrA_pT4l[0]<<", "<<WerrA_pT4l[1]<<", "<<WerrA_pT4l[2]<<", "<<WerrA_pT4l[3]<<", "<<WerrA_pT4l[4]<<", "<<WerrA_pT4l[5]<<", "<<WerrA_pT4l[6]<<", "<<WerrA_pT4l[7]<<", "<<WerrA_pT4l[8]<<"}"<<endl;
  Output<< "double A_pTgt5[9]={"<<WavgA_pT5l[0]<<", "<<WavgA_pT5l[1]<<", "<<WavgA_pT5l[2]<<", "<<WavgA_pT5l[3]<<", "<<WavgA_pT5l[4]<<", "<<WavgA_pT5l[5]<<", "<<WavgA_pT5l[6]<<", "<<WavgA_pT5l[7]<<", "<<WavgA_pT5l[8]<<"}"<<endl;
  Output<< "double AWerr_pTgt5[9] ={"<<WerrA_pT5l[0]<<", "<<WerrA_pT5l[1]<<", "<<WerrA_pT5l[2]<<", "<<WerrA_pT5l[3]<<", "<<WerrA_pT5l[4]<<", "<<WerrA_pT5l[5]<<", "<<WerrA_pT5l[6]<<", "<<WerrA_pT5l[7]<<", "<<WerrA_pT5l[8]<<"}"<<endl;
	 	
		Output << "<<<<<<<<<<<       Eta > 0, Average A_{UT}   >>>>>>>>>>>>>>>>>"<<endl;
  Output<< "double A_pTlt1[9] ={"<<WavgA_pT1g[0]<<", "<<WavgA_pT1g[1]<<", "<<WavgA_pT1g[2]<<", "<<WavgA_pT1g[3]<<", "<<WavgA_pT1g[4]<<", "<<WavgA_pT1g[5]<<", "<<WavgA_pT1g[6]<<", "<<WavgA_pT1g[7]<<", "<<WavgA_pT1g[8]<<"}"<<endl;
  Output<< "double AWerr_pTlt1[9] ={"<<WerrA_pT1g[0]<<", "<<WerrA_pT1g[1]<<", "<<WerrA_pT1g[2]<<", "<<WerrA_pT1g[3]<<", "<<WerrA_pT1g[4]<<", "<<WerrA_pT1g[5]<<", "<<WerrA_pT1g[6]<<", "<<WerrA_pT1g[7]<<", "<<WerrA_pT1g[8]<<"}"<<endl;
  Output<< "double A_pTlt2[9] ={"<<WavgA_pT2g[0]<<", "<<WavgA_pT2g[1]<<", "<<WavgA_pT2g[2]<<", "<<WavgA_pT2g[3]<<", "<<WavgA_pT2g[4]<<", "<<WavgA_pT2g[5]<<", "<<WavgA_pT2g[6]<<", "<<WavgA_pT2g[7]<<", "<<WavgA_pT2g[8]<<"}"<<endl;
  Output<< "double AWerr_pTlt2[9] ={"<<WerrA_pT2g[0]<<", "<<WerrA_pT2g[1]<<", "<<WerrA_pT2g[2]<<", "<<WerrA_pT2g[3]<<", "<<WerrA_pT2g[4]<<", "<<WerrA_pT2g[5]<<", "<<WerrA_pT2g[6]<<", "<<WerrA_pT2g[7]<<", "<<WerrA_pT2g[8]<<"}"<<endl;
  Output<< "double A_pTlt3[9] ={"<<WavgA_pT3g[0]<<", "<<WavgA_pT3g[1]<<", "<<WavgA_pT3g[2]<<", "<<WavgA_pT3g[3]<<", "<<WavgA_pT3g[4]<<", "<<WavgA_pT3g[5]<<", "<<WavgA_pT3g[6]<<", "<<WavgA_pT3g[7]<<", "<<WavgA_pT3g[8]<<"}"<<endl;
  Output<< "double AWerr_pTlt3[9] ={"<<WerrA_pT3g[0]<<", "<<WerrA_pT3g[1]<<", "<<WerrA_pT3g[2]<<", "<<WerrA_pT3g[3]<<", "<<WerrA_pT3g[4]<<", "<<WerrA_pT3g[5]<<", "<<WerrA_pT3g[6]<<", "<<WerrA_pT3g[7]<<", "<<WerrA_pT3g[8]<<"}"<<endl;
  Output<< "double A_pTlt4[9] ={"<<WavgA_pT4g[0]<<", "<<WavgA_pT4g[1]<<", "<<WavgA_pT4g[2]<<", "<<WavgA_pT4g[3]<<", "<<WavgA_pT4g[4]<<", "<<WavgA_pT4g[5]<<", "<<WavgA_pT4g[6]<<", "<<WavgA_pT4g[7]<<", "<<WavgA_pT4g[8]<<"}"<<endl;
  Output<< "double AWerr_pTlt4[9] ={"<<WerrA_pT4g[0]<<", "<<WerrA_pT4g[1]<<", "<<WerrA_pT4g[2]<<", "<<WerrA_pT4g[3]<<", "<<WerrA_pT4g[4]<<", "<<WerrA_pT4g[5]<<", "<<WerrA_pT4g[6]<<", "<<WerrA_pT4g[7]<<", "<<WerrA_pT4g[8]<<"}"<<endl;
  Output<< "double A_pTlt5[9] ={"<<WavgA_pT5g[0]<<", "<<WavgA_pT5g[1]<<", "<<WavgA_pT5g[2]<<", "<<WavgA_pT5g[3]<<", "<<WavgA_pT5g[4]<<", "<<WavgA_pT5g[5]<<", "<<WavgA_pT5g[6]<<", "<<WavgA_pT5g[7]<<", "<<WavgA_pT5g[8]<<"}"<<endl;
  Output<< "double AWerr_pTlt5[9] ={"<<WerrA_pT5g[0]<<", "<<WerrA_pT5g[1]<<", "<<WerrA_pT5g[2]<<", "<<WerrA_pT5g[3]<<", "<<WerrA_pT5g[4]<<", "<<WerrA_pT5g[5]<<", "<<WerrA_pT5g[6]<<", "<<WerrA_pT5g[7]<<", "<<WerrA_pT5g[8]<<"}"<<endl;
...
///////// Signal fractions ///////////////// 
//pion
double pairpuritypTGt[5]={0.995685,0.99413,0.992819,0.981137,0.951615};
double pairpuritypTLt[5]={0.997217,0.995865,0.994613,0.982959,0.954391};
double pairpurityMGt[5]={0.978901,0.98193,0.981563,0.980261,0.971465};
double pairpurityMLt[5]={0.981487,0.984854,0.98391,0.982889,0.973322};
//kaon+proton
...
//-----------------------------
	...
	//print values in table format
	  ofstream ftable;
        ftable.open("ifftable_AutVspTTOFonly.txt");
  ...
  for(int pad=0;pad<6; pad++ ){
		  ...
		  ftable<<M[pad]<<" - "<<M[pad+1]<<" & ";
                  ...
                  gr_AvsMgts[pad] = new TGraphErrors(9,pTAvg,A_Mgt,errxts,finalSysgt);
		  ...
		  gr_AvsMgt[pad] = new TGraphErrors(9,pTAvg,A_Mgt,errx,Aerr_Mgt);//Backward average 
                  ...
                  gr_AvsMlts[pad] = new TGraphErrors(9,pTAvg,A_Mlt,errxts,finalSyslt);//Backward average 
...
myCanAvg->SaveAs("AsymVsPtTOFcutTOFonly.pdf");
...
/*
	...
	myCan->SaveAs("AsymVspT_Cone.7_ForwardTOFonly.pdf");
	myCanA->SaveAs("AsymVspT_Cone.7_AverageTOFonly.pdf");
	...
	//Backward Asymmetry BLUE and YELLOW
		...
		gPad->Update();
	cB->Update();
	cB->SaveAs("AsymmetryVspT_Cone.7_BackwardTOFonly.pdf");
*/	
chi2f->Write();
chi2f->Close();
