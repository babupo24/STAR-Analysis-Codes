...
void integratedBkgAsym_Minv_5bins(const char *ifile="/star/u/pokhrel/GPFS/IFF_TREES/StartLessTOF/iffNtuplesFinalA.root")
{
        gStyle->SetOptFit(0);
        gStyle->SetOptStat(0);
	...
	TTree *ntuple1tofbkg = (TTree*)f->Get("ntuple1tofbkg"); //get trees 
	TTree *ntuple2tofbkg = (TTree*)f->Get("ntuple2tofbkg");
	TTree *ntuple4tofbkg = (TTree*)f->Get("ntuple4tofbkg");
	TTree *ntuple5tofbkg = (TTree*)f->Get("ntuple5tofbkg");
	...
	ofstream out;
	out.open("intAsymMinvTOFonly.txt");


	//get the values of variables from tree 
	

	ntuple1tofbkg->SetBranchAddress("fspinconfig",&fspinconfig);
	ntuple1tofbkg->SetBranchAddress("cone",&cone);
	ntuple2tofbkg->SetBranchAddress("Minv",&Minv);
	ntuple2tofbkg->SetBranchAddress("pT_pair",&pT_pair);
	ntuple2tofbkg->SetBranchAddress("eta_pair",&eta_pair);
	ntuple4tofbkg->SetBranchAddress("PhiRSB",&PhiRSB);
	ntuple4tofbkg->SetBranchAddress("PhiRSY",&PhiRSY);
	ntuple5tofbkg->SetBranchAddress("fitPts_min_pair",&fitPts_min_pair);
	ntuple6->SetBranchAddress("polB_corr", &polB_corr);
	ntuple6->SetBranchAddress("polY_corr", &polY_corr);

	int nentries = (int)ntuple1tofbkg->GetEntries(); //entries of trees 
	...
	ntuple1tofbkg->AddFriend("ntuple2tofbkg"); 
	ntuple1tofbkg->AddFriend("ntuple4tofbkg");
	ntuple1tofbkg->AddFriend("ntuple5tofbkg");
...
//print values in table format
  ofstream ftable;
        ftable.open("ifftable_AutVsMinvIntPtTOFonly.txt");
 ...
 double xerr[5]={0};
 TGraphErrors *gr_BkgTofGt=new TGraphErrors(5,avg_Mgt,WavgA_Mg,xerr,WerrA_Mg);
 ...
 gr_BkgTofGt->GetYaxis()->SetRangeUser(-0.04,0.04);
 gr_BkgTofGt->GetYaxis()->SetNdivisions(505);
 gr_BkgTofGt->GetXaxis()->SetLimits(0.21, 1.9);
 gr_BkgTofGt->GetXaxis()->SetTitle("#font[22]{M^{#pi^{+}#pi^{-}} (p_{T} integrated)}");
 ...
 TGraphErrors *gr_BkgTofLt=new TGraphErrors(5,avg_Mgt,WavgA_Ml,xerr,WerrA_Ml);
...
//draw background asymmetry
 ...
 TLatex tb;
 tb.SetTextSize(0.04);
 tb.DrawLatex(0.28,0.03,Form("#color[4]{chi2/ndf: %4.2g / %i}",gr_BkgTofLt->GetFunction("pol0")->GetChisquare(), gr_BkgTofLt->GetFunction("pol0")->GetNDF()));
 tb.DrawLatex(0.28,0.025,Form("#color[4]{p0: %4.4g #pm %4.4g}",gr_BkgTofLt->GetFunction("pol0")->GetParameter(0), gr_BkgTofLt->GetFunction("pol0")->GetParError(0)));
 tb.DrawLatex(0.28,-0.03,Form("#color[2]{chi2/ndf: %4.2g / %i}",gr_BkgTofGt->GetFunction("pol0")->GetChisquare(), gr_BkgTofGt->GetFunction("pol0")->GetNDF()));
 tb.DrawLatex(0.28,-0.035,Form("#color[2]{p0: %4.4g #pm %4.4g}",gr_BkgTofGt->GetFunction("pol0")->GetParameter(0), gr_BkgTofGt->GetFunction("pol0")->GetParError(0)));
 gPad->Update();
...
/*
	double avg_pT7=5.25;
     ...
     myCanF->Update();
     myCanF->SaveAs("asymVsMinvIntpTTOFonly.pdf");
//------------------------
*/
