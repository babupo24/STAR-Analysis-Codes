...
void integratedAsym_Minv_9bins(const char *ifile="/star/u/pokhrel/GPFS/IFF_TREES/StartLessTOF/dihadNtuples.root")
{
...
//print values in table format
 ...
 for(int i=0; i<9; i++){
 	...
 	ftable<<M[i]<<" - "<<M[i+1]<< " & "<<avg_pTgt[i]<<" & "<<avg_Mgt[i]<<" & "<< WavgA_Mg[i]<<" & "<<WerrA_Mg[i]<< " & "<<pidSysGt[i]<<" & "<<biasSysGt[i]<<" & " <<combSysGt[i]<< " & "<<WavgA_Ml[i]<<" & "<<WerrA_Ml[i]<< " & "<<pidSysLt[i]<<" & "<<biasSysLt[i]<<" & " <<combSysLt[i]<<" \\\\ "<<endl;
		...
		cout<<"//---------Weighted----asymmetries--------------   "<<endl;
		out << "double WavgAsymGt[9]={"<<WavgA_Mg[0]<<", "<<WavgA_Mg[1]<< ","<<WavgA_Mg[2]<< ","<<WavgA_Mg[3]<<", "<<WavgA_Mg[4]<<", "<<WavgA_Mg[5]<<", "<<WavgA_Mg[6]<<", "<<WavgA_Mg[7]<<", "<<WavgA_Mg[8]<<"}"<<endl; 
		out << "double WerrAsymGt[9]={"<<WerrA_Mg[0]<<", "<<WerrA_Mg[1]<< ","<<WerrA_Mg[2]<< ","<<WerrA_Mg[3]<<", "<<WerrA_Mg[4]<<", "<<WerrA_Mg[5]<<", "<<WerrA_Mg[6]<<", "<<WerrA_Mg[7]<<", "<<WerrA_Mg[8]<<"}"<<endl; 
		out << "double WerrAsymGt[9]={"<<WerrA_Mg[0]<<", "<<WerrA_Mg[1]<< ","<<WerrA_Mg[2]<< ","<<WerrA_Mg[3]<<", "<<WerrA_Mg[4]<<", "<<WerrA_Mg[5]<<", "<<WerrA_Mg[6]<<", "<<WerrA_Mg[7]<<", "<<WerrA_Mg[8]<<"}"<<endl; 
		out << "double SysGt[9]={"<<biasSysGt[0]<<", "<<biasSysGt[1]<< ","<<biasSysGt[2]<< ","<<biasSysGt[3]<<", "<<biasSysGt[4]<<", "<<biasSysGt[5]<<", "<<biasSysGt[6]<<", "<<biasSysGt[7]<<", "<<biasSysGt[8]<<"}"<<endl; 
		
		out << "double WavgAsymLt[9]={"<<WavgA_Ml[0]<<", "<<WavgA_Ml[1]<< ","<<WavgA_Ml[2]<< ","<<WavgA_Ml[3]<<", "<<WavgA_Ml[4]<<", "<<WavgA_Ml[5]<<", "<<WavgA_Ml[6]<<", "<<WavgA_Ml[7]<<", "<<WavgA_Ml[8]<<"}"<<endl; 
		out << "double WerrAsymLt[9]={"<<WerrA_Ml[0]<<", "<<WerrA_Ml[1]<< ","<<WerrA_Ml[2]<< ","<<WerrA_Ml[3]<<", "<<WerrA_Ml[4]<<", "<<WerrA_Ml[5]<<", "<<WerrA_Ml[6]<<", "<<WerrA_Ml[7]<<", "<<WerrA_Ml[8]<<"}"<<endl; 
		out << "double WerrAsymLt[9]={"<<WerrA_Ml[0]<<", "<<WerrA_Ml[1]<< ","<<WerrA_Ml[2]<< ","<<WerrA_Ml[3]<<", "<<WerrA_Ml[4]<<", "<<WerrA_Ml[5]<<", "<<WerrA_Ml[6]<<", "<<WerrA_Ml[7]<<", "<<WerrA_Ml[8]<<"}"<<endl; 
		out << "double SysLt[9]={"<<biasSysLt[0]<<", "<<biasSysLt[1]<< ","<<biasSysLt[2]<< ","<<biasSysLt[3]<<", "<<biasSysLt[4]<<", "<<biasSysLt[5]<<", "<<biasSysLt[6]<<", "<<biasSysLt[7]<<", "<<biasSysLt[8]<<"}"<<endl; 
	...
	double avg_pT7=5.25;
     ...
     TGraphErrors *Run15s = new TGraphErrors(9,avg_Mgt,WavgA_Mg,errxps,biasSysGt);
