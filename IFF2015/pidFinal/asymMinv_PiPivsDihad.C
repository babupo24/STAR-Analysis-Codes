...
//h^+h^- asymmetry 
double  A_pT1Gt[9] ={0.00532548, 0.00269676, 0.00717004, 0.00373356, 0.003464, 0.00550161, 0.00864809, 0.0018649, -0.00341604};
double  AWerr_pT1Gt[9] ={0.0023404, 0.00251108, 0.00249049, 0.00247647, 0.00254722, 0.00257244, 0.00257131, 0.00256825, 0.00254004};
double Sys_pTgt1[9]={0.000529353, 0.000268058, 0.000712702, 0.000371116, 0.000344321, 0.00054686, 0.00085962, 0.000255284, 0.00025248};
double  A_pT2Gt[9] ={0.00332486, 0.00313553, 0.00945137, 0.00947574, 0.0134793, 0.00869935, 0.00502974, 0.00112634, -0.00154953};
double  AWerr_pT2Gt[9] ={0.00219972, 0.0023763, 0.00235307, 0.0023216, 0.00240995, 0.00241022, 0.00237782, 0.00235118, 0.00234811};
double Sys_pTgt2[9]={0.000280618, 0.000264639, 0.000797696, 0.000799752, 0.00113766, 0.000734225, 0.00042451, 0.00019844, 0.00019818};
double  A_pT3Gt[9] ={-0.000260156, 0.00866251, 0.00954973, 0.00959359, 0.0157593, 0.014257, 0.00650737, 0.00428835, -0.000121141};
double  AWerr_pT3Gt[9] ={0.00213009, 0.00230891, 0.00226251, 0.00222898, 0.00234417, 0.00233316, 0.00226799, 0.00223172, 0.0022282};
double Sys_pTgt3[9]={-0.00023005, -0.000935551, -0.00103137, -0.00103611, -0.00170201, -0.00153976, -0.000702796, -0.000463142, -0.000240645};
double  A_pT4Gt[9] ={0.00609856, 0.00274595, 0.0110051, 0.0166428, 0.0219509, 0.0191293, 0.0144623, 0.00472105, 0.000690321};
double  AWerr_pT4Gt[9] ={0.00209608, 0.00225738, 0.002196, 0.00220681, 0.00231586, 0.00228446, 0.00221425, 0.00217102, 0.00214192};
double Sys_pTgt4[9]={-0.00050618, -0.000227913, -0.000913425, -0.00138135, -0.00182192, -0.00158773, -0.00120037, -0.000391847, -0.000177779};
double  A_pT5Gt[9] ={0.00555649, 0.0132114, 0.0215854, 0.0310777, 0.0405555, 0.035682, 0.0248256, 0.0183023, 0.0136659};
double  AWerr_pT5Gt[9] ={0.00209083, 0.00222352, 0.00216154, 0.00228693, 0.00237346, 0.00229474, 0.00217927, 0.00213986, 0.00211892};
double Sys_pTgt5[9]={-0.000177808, -0.000422764, -0.000690733, -0.000994487, -0.00129778, -0.00114183, -0.00079442, -0.000585674, -0.000437308};

double  A_pT1Lt[9] ={0.00205937, -0.00355446, -0.00229491, 0.00150707, -0.000596346, 0.00250158, 0.00558363, -0.00331975, 0.00318447};
double  AWerr_pT1Lt[9]={0.00233696, 0.00250639, 0.00248754, 0.00246769, 0.00254278, 0.002568, 0.00257028, 0.00256815, 0.00253533};
double Sys_pTlt1[9]={0.000221777, 0.000237857, 0.000236067, 0.000234184, 0.00024131, 0.000243703, 0.000529886, 0.000243717, 0.000302207};
double  A_pT2Lt[9]={-0.00189805, 0.00339794, 0.00154146, 0.00166759, 0.00316144, 0.000886762, -0.00122977, 0.00302342, 0.000291191};
double  AWerr_pT2Lt[9] ={0.00219738, 0.00238373, 0.00234185, 0.00230998, 0.00239813, 0.00240475, 0.00237795, 0.00234806, 0.00234345};
double Sys_pTlt2[9]={-0.00022633, -0.000349988, -0.000241211, -0.000237928, -0.000325629, -0.000247689, -0.000244929, -0.000311412, -0.000241375};
double A_pT3Lt[9] ={-0.00205546, 0.00132606, 0.00262109, 0.00531466, 0.00320422, 0.00967479, 0.00227973, -0.00150872, 0.0020416};
double AWerr_pT3Lt[9] ={0.00212628, 0.00230014, 0.00226029, 0.00222217, 0.00232274, 0.00231235, 0.0022605, 0.00223025, 0.00222417};
double Sys_pTlt3[9]={-0.000180734, -0.000195512, -0.000222792, -0.000451747, -0.000272359, -0.000822357, -0.000193777, -0.000189572, -0.000189055};
double  A_pT4Lt[9] ={-0.000990322, -0.000964324, 0.00118502, 0.00208451, 0.00271913, 0.00206385, 0.000488238, 0.001429, 0.00185615};
double AWerr_pT4Lt[9] ={0.00208916, 0.00225787, 0.00217828, 0.00218341, 0.00226575, 0.00224642, 0.00218973, 0.00216051, 0.00213583};
double Sys_pTlt4[9]={-8.77446e-05, -9.48306e-05, -9.14878e-05, -9.17031e-05, -0.000114204, -9.43497e-05, -9.19689e-05, -9.07414e-05, -8.97049e-05};
double  A_pT5Lt[9] ={0.00241101, 0.00868441, 0.00282293, 0.00381831, 0.0069365, 0.00794542, 0.00582099, 0.00179506, 0.000907438};
double AWerr_pT5Lt[9] ={0.00208447, 0.00221658, 0.00211585, 0.00219549, 0.00224075, 0.00218451, 0.00211717, 0.0021474, 0.00212582};
double Sys_pTlt5[9]={-0.000139839, -0.000503696, -0.00016373, -0.000221462, -0.000402317, -0.000460834, -0.000337617, -0.000124549, -0.000123298};
//--------------
 ...
 for(int i=0; i<9; i++){
  ...
  rrdiff1Gt[i]=(double)(A_F1Gt[i]-A_Tof1Gt[i])/A_F1Gt[i];//relative difference
  rrdiff1errGt[i]=(double)calErr(A_F1Gt[i],AWerr_F1Gt[i],A_Tof1Gt[i],AWerr_Tof1Gt[i]);//relative difference
  rrdiff2Gt[i]=(double)(A_F2Gt[i]-A_Tof2Gt[i])/A_F2Gt[i];
  rrdiff2errGt[i]=(double)calErr(A_F2Gt[i],AWerr_F2Gt[i],A_Tof2Gt[i],AWerr_Tof2Gt[i]);//relative difference
  rrdiff3Gt[i]=(double)(A_F3Gt[i]-A_Tof3Gt[i])/A_F3Gt[i];
  rrdiff3errGt[i]=(double)calErr(A_F3Gt[i],AWerr_F3Gt[i],A_Tof3Gt[i],AWerr_Tof3Gt[i]);//relative difference
  rrdiff4Gt[i]=(double)(A_F4Gt[i]-A_Tof4Gt[i])/A_F4Gt[i];
  rrdiff4errGt[i]=(double)calErr(A_F4Gt[i],AWerr_F4Gt[i],A_Tof4Gt[i],AWerr_Tof4Gt[i]);//relative difference
  rrdiff5Gt[i]=(double)(A_F5Gt[i]-A_Tof5Gt[i])/A_F5Gt[i];
  rrdiff5errGt[i]=(double)calErr(A_F5Gt[i],AWerr_F5Gt[i],A_Tof5Gt[i],AWerr_Tof5Gt[i]);//relative difference

  rrdiff1Lt[i]=(double)(A_F1Lt[i]-A_Tof1Lt[i])/A_F1Lt[i];//relative difference
  rrdiff1errLt[i]=(double)calErr(A_F1Lt[i],AWerr_F1Lt[i],A_Tof1Lt[i],AWerr_Tof1Lt[i]);//relative difference
  rrdiff2Lt[i]=(double)(A_F2Lt[i]-A_Tof2Lt[i])/A_F2Lt[i];
  rrdiff2errLt[i]=(double)calErr(A_F2Lt[i],AWerr_F2Lt[i],A_Tof2Lt[i],AWerr_Tof2Lt[i]);//relative difference
  rrdiff3Lt[i]=(double)(A_F3Lt[i]-A_Tof3Lt[i])/A_F3Lt[i];
  rrdiff3errLt[i]=(double)calErr(A_F3Lt[i],AWerr_F3Lt[i],A_Tof3Lt[i],AWerr_Tof3Lt[i]);//relative difference
  rrdiff4Lt[i]=(double)(A_F4Lt[i]-A_Tof4Lt[i])/A_F4Lt[i];
  rrdiff4errLt[i]=(double)calErr(A_F4Lt[i],AWerr_F4Lt[i],A_Tof4Lt[i],AWerr_Tof4Lt[i]);//relative difference
  rrdiff5Lt[i]=(double)(A_F5Lt[i]-A_Tof5Lt[i])/A_F5Lt[i];
  rrdiff5errLt[i]=(double)calErr(A_F5Lt[i],AWerr_F5Lt[i],A_Tof5Lt[i],AWerr_Tof5Lt[i]);//relative difference
cout<<"Bin:  "<<i<<" a: "<<A_F1Lt[i]<<", ae: "<<AWerr_F1Lt[i]<<", b: "<<A_Tof1Lt[i]<<", eb: "<<AWerr_Tof1Lt[i]<<", rdiff: "<<rrdiff1Lt[i]<<" ,rdiff err.: "<<rrdiff1errLt[i]<<endl;

  pidSysGt1[i]=(1.0-pionPairPtGtT[0])*abs(max(A_F1Gt[i],AWerr_F1Gt[i]));
  pidSysGt2[i]=(1.0-pionPairPtGtT[1])*abs(max(A_F2Gt[i],AWerr_F2Gt[i]));
  pidSysGt3[i]=(1.0-pionPairPtGtT[2])*abs(max(A_F3Gt[i],AWerr_F3Gt[i]));
  pidSysGt4[i]=(1.0-pionPairPtGtT[3])*abs(max(A_F4Gt[i],AWerr_F4Gt[i]));
  pidSysGt5[i]=(1.0-pionPairPtGtT[4])*abs(max(A_F5Gt[i],AWerr_F5Gt[i]));

  pidSysLt1[i]=(1.0-pionPairPtLtT[0])*abs(max(A_F1Lt[i],AWerr_F1Lt[i]));
  pidSysLt2[i]=(1.0-pionPairPtLtT[1])*abs(max(A_F2Lt[i],AWerr_F2Lt[i]));
  pidSysLt3[i]=(1.0-pionPairPtLtT[2])*abs(max(A_F3Lt[i],AWerr_F3Lt[i]));
  pidSysLt4[i]=(1.0-pionPairPtLtT[3])*abs(max(A_F4Lt[i],AWerr_F4Lt[i]));
  pidSysLt5[i]=(1.0-pionPairPtLtT[4])*abs(max(A_F5Lt[i],AWerr_F5Lt[i]));
 ...
 double A_DiGt[9]={0};
 double Aerr_DiGt[9]={0};
 double A_DiLt[9]={0};
 double Aerr_DiLt[9]={0};


double A_TTGt[9]={0};//Tof&&TPC both
 double Aerr_TTGt[9]={0};
 double A_TTLt[9]={0};
 double Aerr_TTLt[9]={0};

 double A_ToTGt[9]={0};//Tpc or TPC&&TOF both
 double Aerr_ToTGt[9]={0};
 double A_ToTLt[9]={0};
 double Aerr_ToTLt[9]={0};

 TGraphErrors *gr_DiGtS[5]={0};
 TGraphErrors *gr_DiLtS[5]={0};

 TGraphErrors *gr_DiGt[5]={0};
 TGraphErrors *gr_DiLt[5]={0};
 TGraphErrors *gr_FGtS[5]={0};
 TGraphErrors *gr_FLtS[5]={0};
 TGraphErrors *gr_F2GtS[5]={0};
 TGraphErrors *gr_F2LtS[5]={0};
 TGraphErrors *gr_F2Gt[5]={0};
 TGraphErrors *gr_F2Lt[5]={0};
 TGraphErrors *gr_TTGt[5]={0};
 TGraphErrors *gr_ToTGt[5]={0};
double frp0Gt[5]={0};
double frp0Lt[5]={0};
...
// graph for TPC && TOF
  gr_TTGt[pad] = new TGraphErrors(9,M, A_TTGt,errx,Aerr_TTGt);//
  gr_TTGt[pad]-> SetMarkerStyle(24);
  gr_TTGt[pad]-> SetMarkerColor(4);
  gr_TTGt[pad]-> SetLineColor(4);
  gr_TTGt[pad]-> SetLineWidth(1);
// graph for TPC only or TPC && TOF
  gr_ToTGt[pad] = new TGraphErrors(9,M, A_ToTGt,errx,Aerr_ToTGt);
  gr_ToTGt[pad]-> SetMarkerStyle(25);
  gr_ToTGt[pad]-> SetMarkerColor(1);
  gr_ToTGt[pad]-> SetLineColor(1);
  gr_ToTGt[pad]-> SetLineWidth(1);
  ...
  gr_rrdiffGt[pad]->GetYaxis()->SetRangeUser(-5., 5);
...
//Relative difference 
 ...
 for(int pad=0; pad<6; pad++){
  ...
  if(pad==5){
   ...
   tex[pad].DrawLatex(1.2,4.0,Form("#font[22]{#color[2]{chi2/ndf  = %g / %i}}",gr_rrdiffGt[pad]->GetFunction("pol0")->GetChisquare(),gr_rrdiffGt[pad]->GetFunction("pol0")->GetNDF()));
   tex[pad].DrawLatex(1.2,3.5,Form("#font[22]{#color[2]{p0  = %g #pm %g}}",gr_rrdiffGt[pad]->GetFunction("pol0")->GetParameter(0),gr_rrdiffGt[pad]->GetFunction("pol0")->GetParError(0)));

   tex[pad].DrawLatex(1.2,3.0,Form("#font[22]{#color[4]{chi2/ndf  = %g / %i}}",gr_rrdiffLt[pad]->GetFunction("pol0")->GetChisquare(),gr_rrdiffLt[pad]->GetFunction("pol0")->GetNDF()));
   tex[pad].DrawLatex(1.2,2.5,Form("#font[22]{#color[4]{p0  = %g #pm %g}}",gr_rrdiffLt[pad]->GetFunction("pol0")->GetParameter(0),gr_rrdiffLt[pad]->GetFunction("pol0")->GetParError(0)));

   tex[pad].DrawLatex(1.7,4.6,Form("#font[22]{#color[1]{< p_{T} > = %g GeV/c}}",avgPt[pad]));

   gPad->Update();
  }
 }
 crdiff->Update();
 crdiff->SaveAs("./Plots/pidsysRelativeDiffWithTpc_AutVsMinv.pdf");
//-----------------------
//draw asymmetries for different purity
 ...
 for(int pad=0; pad<6; pad++){
  ...
  if(pad==5){
   ...
   tex[pad].SetTextAlign(13);
   tex[pad].DrawLatex(0.1, 0.7, "#font[22]{ #eta^{#pi^{+}#pi^{-}} #GT 0 }");
   tex[pad].DrawLatex(0.1, 0.6, "#font[22]{#color[2]{#bullet  -1<n#sigma_{#pi}<2}}");
   tex[pad].DrawLatex(0.1, 0.5, "#font[22]{#color[4]{#circ  -1<n#sigma_{#pi}<2 && TOF cut }}");
   tex[pad].DrawLatex(0.1, 0.4, "#font[22]{#Box  -1<n#sigma_{#pi}<2 && TOF cut(if TOF }");
   tex[pad].DrawLatex(0.1, 0.32, "#font[22]{       is available.) }");

  }else if(pad<5){
   gPad->SetGrid(0,0);
   gr_AvsMFGt[pad]->Draw("AP");
   if(pad==1 || pad==2 || pad==4)gr_AvsMFGt[pad]->GetYaxis()->SetLabelSize(0);
   gr_AvsMFGt[pad]->GetYaxis()->SetNdivisions(505);
   gr_AvsMFGt[pad]->GetXaxis()->SetNdivisions(505);

   gr_TTGt[pad]->Draw("SAME P");
   gr_ToTGt[pad]->Draw("SAME P");
 ...
 cdiff->Update();
 cdiff->SaveAs("./Plots/pidsysAsymComparison_AutVsMinv.pdf");
//--------------------------
...
*/
  //final systematics. Combined trigger bias and PID as quadrature sum
  combSysMGt1[i]=sqrt(pow(biasMGt1[i],2) + pow(frp0Gt[0]*A_F1Gt[i],2));
  combSysMGt2[i]=sqrt(pow(biasMGt2[i],2) + pow(frp0Gt[1]*A_F2Gt[i],2));
  combSysMGt3[i]=sqrt(pow(biasMGt3[i],2) + pow(frp0Gt[2]*A_F3Gt[i],2));
  combSysMGt4[i]=sqrt(pow(biasMGt4[i],2) + pow(frp0Gt[3]*A_F4Gt[i],2));
  combSysMGt5[i]=sqrt(pow(biasMGt5[i],2) + pow(frp0Gt[4]*A_F5Gt[i],2));
  //cout<<"trig bias: "<<biasMGt1[i]<<", pid: "<<Gt1[i]<<",  combined: "<<combSysMGt1[i]<<endl;
  combSysMLt1[i]=sqrt(pow(biasMLt1[i],2) + pow(frp0Lt[0]*A_F1Lt[i],2));
  combSysMLt2[i]=sqrt(pow(biasMLt2[i],2) + pow(frp0Lt[1]*A_F2Lt[i],2));
  combSysMLt3[i]=sqrt(pow(biasMLt3[i],2) + pow(frp0Lt[2]*A_F3Lt[i],2));
  combSysMLt4[i]=sqrt(pow(biasMLt4[i],2) + pow(frp0Lt[3]*A_F4Lt[i],2));
  combSysMLt5[i]=sqrt(pow(biasMLt5[i],2) + pow(frp0Lt[4]*A_F5Lt[i],2));

  if(i==8){
  cout<<combSysMGt5[i]<<": Combined Systematic uncertainty pT bin 5"<<endl;
 }else{cout<<combSysMGt5[i]<<", ";}
}
 ...
 TCanvas *cDivsPi=new TCanvas("cDivsPi","",150,10,1100,700);
 cDivsPi->Divide(3,2,0,0);
 ...
 for(int pad=0;pad<6; pad++ ){
  if(pad==5){
   ...
   if(pad==0)for(int mbin=0; mbin<9; mbin++){ M[mbin]=M1[mbin];  A_FGt[mbin]=A_F1Gt[mbin]; Aerr_FGt[mbin]=AWerr_F1Gt[mbin]; A_FLt[mbin]=A_F1Lt[mbin]; Aerr_FLt[mbin]=AWerr_F1Lt[mbin]; finalSysGt[mbin]=combSysMGt1[mbin]; finalSysLt[mbin]=combSysMLt1[mbin]; A_DiGt[mbin]=A_pT1Gt[mbin]; Aerr_DiGt[mbin]=AWerr_pT1Gt[mbin]; A_DiLt[mbin]=A_pT1Lt[mbin]; Aerr_DiLt[mbin]=AWerr_pT1Lt[mbin]; biasSysGt[mbin]=biasMGt1[mbin]; biasSysLt[mbin]=biasMLt1[mbin]; }
   if(pad==1)for(int mbin=0; mbin<9; mbin++){M[mbin]=M2[mbin];  A_FGt[mbin]=A_F2Gt[mbin]; Aerr_FGt[mbin]=AWerr_F2Gt[mbin]; A_FLt[mbin]=A_F2Lt[mbin]; Aerr_FLt[mbin]=AWerr_F2Lt[mbin];  finalSysGt[mbin]=combSysMGt2[mbin]; finalSysLt[mbin]=combSysMLt2[mbin];  A_DiGt[mbin]=A_pT2Gt[mbin]; Aerr_DiGt[mbin]=AWerr_pT2Gt[mbin]; A_DiLt[mbin]=A_pT2Lt[mbin]; Aerr_DiLt[mbin]=AWerr_pT2Lt[mbin]; biasSysGt[mbin]=biasMGt2[mbin]; biasSysLt[mbin]=biasMLt2[mbin];}
   if(pad==2)for(int mbin=0; mbin<9; mbin++){M[mbin]=M3[mbin];  A_FGt[mbin]=A_F3Gt[mbin]; Aerr_FGt[mbin]=AWerr_F3Gt[mbin]; A_FLt[mbin]=A_F3Lt[mbin]; Aerr_FLt[mbin]=AWerr_F3Lt[mbin];  finalSysGt[mbin]=combSysMGt3[mbin]; finalSysLt[mbin]=combSysMLt3[mbin];  A_DiGt[mbin]=A_pT3Gt[mbin]; Aerr_DiGt[mbin]=AWerr_pT3Gt[mbin]; A_DiLt[mbin]=A_pT3Lt[mbin]; Aerr_DiLt[mbin]=AWerr_pT3Lt[mbin]; biasSysGt[mbin]=biasMGt3[mbin]; biasSysLt[mbin]=biasMLt3[mbin];}
   if(pad==3)for(int mbin=0; mbin<9; mbin++){M[mbin]=M4[mbin];  A_FGt[mbin]=A_F4Gt[mbin]; Aerr_FGt[mbin]=AWerr_F4Gt[mbin]; A_FLt[mbin]=A_F4Lt[mbin]; Aerr_FLt[mbin]=AWerr_F4Lt[mbin];  finalSysGt[mbin]=combSysMGt4[mbin]; finalSysLt[mbin]=combSysMLt4[mbin];  A_DiGt[mbin]=A_pT4Gt[mbin]; Aerr_DiGt[mbin]=AWerr_pT4Gt[mbin]; A_DiLt[mbin]=A_pT4Lt[mbin]; Aerr_DiLt[mbin]=AWerr_pT4Lt[mbin]; biasSysGt[mbin]=biasMGt4[mbin]; biasSysLt[mbin]=biasMLt4[mbin]; }
   if(pad==4)for(int mbin=0; mbin<9; mbin++){M[mbin]=M5[mbin];  A_FGt[mbin]=A_F5Gt[mbin]; Aerr_FGt[mbin]=AWerr_F5Gt[mbin]; A_FLt[mbin]=A_F5Lt[mbin]; Aerr_FLt[mbin]=AWerr_F5Lt[mbin];  finalSysGt[mbin]=combSysMGt5[mbin]; finalSysLt[mbin]=combSysMLt5[mbin];  A_DiGt[mbin]=A_pT5Gt[mbin]; Aerr_DiGt[mbin]=AWerr_pT5Gt[mbin]; A_DiLt[mbin]=A_pT5Lt[mbin]; Aerr_DiLt[mbin]=AWerr_pT5Lt[mbin]; biasSysGt[mbin]=biasMGt5[mbin]; biasSysLt[mbin]=biasMLt5[mbin]; }

   gr_DiGtS[pad] = new TGraphErrors(9,M,A_DiGt,errxts,biasSysGt);
   gr_DiGtS[pad]->GetYaxis()-> SetTitle("#font[22]{A_{UT}^{Sin(#Phi_{S}-#Phi_{R})}} ");
   gr_DiGtS[pad]->SetTitle("");
   gr_DiGtS[pad]->GetYaxis()->SetTitleOffset(1.2);
   gr_DiGtS[pad]->GetYaxis()->SetTitleSize(0.06);
   gr_DiGtS[pad]->GetYaxis()->SetLabelSize(0.06);
   gr_DiGtS[pad]->GetYaxis()->SetLabelFont(22);
   gr_DiGtS[pad]->GetXaxis()->SetTitle("#font[22]{M_{#pi^{+}#pi^{-}} (GeV/c^{2})}   ");
   gr_DiGtS[pad]->GetXaxis()->SetTitleSize(0.06);
   gr_DiGtS[pad]->GetXaxis()->SetLabelSize(0.06);
   gr_DiGtS[pad]->GetXaxis()-> SetLabelFont(22);
   gr_DiGtS[pad]->GetXaxis()->SetLimits(0.2,2.3);
   gr_DiGtS[pad]->GetYaxis()->SetRangeUser(-0.015, 0.063);
   gr_DiGtS[pad]->SetFillStyle(0000);
   gr_DiGtS[pad]->SetLineColor(4);
   gr_DiGtS[pad]->SetLineWidth(1);

   gr_DiLtS[pad] = new TGraphErrors(9,M,A_DiLt,errxts,biasSysLt);
   gr_DiLtS[pad]->SetFillStyle(0000);
   gr_DiLtS[pad]->SetLineColor(1);
   gr_DiLtS[pad]->SetLineWidth(1);

   gr_DiGt[pad] = new TGraphErrors(9,M,A_DiGt,errxts,Aerr_DiGt);
   gr_DiGt[pad]-> SetMarkerStyle(20);
   gr_DiGt[pad]-> SetMarkerColor(4);
   gr_DiGt[pad]-> SetLineColor(4);
   gr_DiGt[pad]-> SetLineWidth(1);

   gr_DiLt[pad] = new TGraphErrors(9,M,A_DiLt,errxts,Aerr_DiLt);
   gr_DiLt[pad]-> SetMarkerStyle(20);
   gr_DiLt[pad]-> SetMarkerColor(4);
   gr_DiLt[pad]-> SetLineColor(4);
   gr_DiLt[pad]-> SetLineWidth(1);

   gr_F2GtS[pad] = new TGraphErrors(9,M,A_FGt,errxts,finalSysGt);
   gr_F2GtS[pad]->SetFillStyle(0000);
   gr_F2GtS[pad]->SetLineColor(2);
   gr_F2GtS[pad]->SetLineWidth(1);

   gr_F2LtS[pad] = new TGraphErrors(9,M,A_FLt,errxts,finalSysLt);
   gr_F2LtS[pad]->SetFillStyle(0000);
   gr_F2LtS[pad]->SetLineColor(1);
   gr_F2LtS[pad]->SetLineWidth(1);

   gr_F2Gt[pad] = new TGraphErrors(9,M,A_FGt,errxts,Aerr_FGt);
   gr_F2Gt[pad]-> SetMarkerStyle(24);
   gr_F2Gt[pad]-> SetMarkerColor(2);
   gr_F2Gt[pad]-> SetLineColor(2);
   gr_F2Gt[pad]-> SetLineWidth(1);

   gr_F2Lt[pad] = new TGraphErrors(9,M,A_FLt,errxts,Aerr_FLt);
   gr_F2Lt[pad]-> SetMarkerStyle(20);
   gr_F2Lt[pad]-> SetMarkerColor(4);
   gr_F2Lt[pad]-> SetLineColor(4);
   gr_F2Lt[pad]-> SetLineWidth(1);
   ...
   gr_DiGtS[pad]->Draw("AP2");
   if(pad==1 ||pad==2 || pad==4){
    gr_DiGtS[pad]->GetYaxis()->SetLabelSize(0);
    gr_DiGtS[pad]->GetYaxis()->SetTitle("");
   }
   gr_DiGtS[pad]->GetYaxis()->SetNdivisions(505);
   gr_DiGtS[pad]->GetXaxis()->SetNdivisions(505);
   //gr_FLtS[pad]->Draw("SAME 2");
   gr_DiGt[pad]->Draw("SAME P");
   gr_F2GtS[pad]->Draw("SAME 2");
   gr_F2Gt[pad]->Draw("SAME P");
   //gr_DiLt[pad]->Draw("SAME P");

   gPad->Update();
   line[pad]=  new TLine(cDivsPi->cd(pad+1)->GetUxmin(),0.,cDivsPi->cd(pad+1)->GetUxmax(),0.);
   line[pad]->SetLineStyle(2);
   line[pad]->SetLineWidth(1);
   line[pad]->Draw();
   ...
   if(pad==0){
    leg[pad] = new TLegend(0.24,.55, 0.55, 0.8);
    leg[pad]->AddEntry(gr_F2Gt[pad], " #font[22]{ #eta^{#pi^{+}#pi^{-}} > 0}", "lp");
    leg[pad]->AddEntry(gr_DiGt[pad], " #font[22]{ #eta^{h^{+}h^{-}} > 0}", "lp");
    leg[pad]->AddEntry(gr_F2GtS[pad], " #font[22]{ #pi^{+}#pi^{-} Syst. Error}", "f");
    leg[pad]->AddEntry(gr_DiGtS[pad], " #font[22]{ h^{+}h^{-} Syst. Error}", "f");
 ...
 cDivsPi->Update();
 cDivsPi->SaveAs("./Plots/DihadVsPionAut_Minv.pdf");
 cfinal->Update();
