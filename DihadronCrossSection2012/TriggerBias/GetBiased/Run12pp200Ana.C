...
void Run12pp200Ana(const char *ifile = "/star/u/pokhrel/GPFS/Run12EmbeddingTrees/v3/tree_13055068.root", const char *ofile = "testEmbedHist.root") // interactive mode
