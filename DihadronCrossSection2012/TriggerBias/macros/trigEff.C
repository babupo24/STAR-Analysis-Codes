...
void trigEff()
{
	...
	TFile *fbiased = new TFile("GetBiased/histBiased.root", "R");
	TFile *funbiased = new TFile("GetUnbiased/histUnbiased.root", "R");
	...
	TH1D *hMTrigJP0 = (TH1D *)fbiased->Get("hBiasedMinvJP0");
	TH1D *hMTrigJP1 = (TH1D *)fbiased->Get("hBiasedMinvJP1");
	TH1D *hMTrigJP2 = (TH1D *)fbiased->Get("hBiasedMinvJP2");
