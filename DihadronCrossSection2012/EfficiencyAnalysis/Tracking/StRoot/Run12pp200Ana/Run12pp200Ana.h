...
public:
        ...
        TH1D *hGenRecJP0PosX; // numerator
        TH1D *hGenJP0PosX;    // denominator
        TH1D *hGenRecJP0NegX; // numerator
        TH1D *hGenJP0NegX;    // denominator

        TH1D *hGenRecJP1PosX; // numerator
        TH1D *hGenJP1PosX;    // denominator
        TH1D *hGenRecJP1NegX; // numerator
        TH1D *hGenJP1NegX;    // denominator

        TH1D *hGenRecJP2PosX; // numerator
        TH1D *hGenJP2PosX;    // denominator
        TH1D *hGenRecJP2NegX; // numerator
        TH1D *hGenJP2NegX;    // denominator

        // pt in mass bins but acceptance effect accounted
        TH1D *hGenRecJP0Pos; // numerator
        TH1D *hGenJP0Pos;    // denominator
        TH1D *hGenRecJP0Neg; // numerator
        TH1D *hGenJP0Neg;    // denominator

        TH1D *hGenRecJP1Pos; // numerator
        TH1D *hGenJP1Pos;    // denominator
        TH1D *hGenRecJP1Neg; // numerator
        TH1D *hGenJP1Neg;    // denominator

        TH1D *hGenRecJP2Pos; // numerator
        TH1D *hGenJP2Pos;    // denominator
        TH1D *hGenRecJP2Neg; // numerator
        TH1D *hGenJP2Neg;    // denominator
        ...
        TH1D *hpairGenJP0X;
        TH1D *hpairGenRecJP0X;

        TH1D *hpairGenJP1X;
        TH1D *hpairGenRecJP1X;

        TH1D *hpairGenJP2X;
        TH1D *hpairGenRecJP2X;
        ...
        TH1D *hpairGenRecJP0XC2;
        TH1D *hpairGenRecJP0XC3;
        TH1D *hpairGenRecJP0XC4;
        TH1D *hpairGenRecJP0XC5;

        TH1D *hpairGenRecJP1XC2;
        TH1D *hpairGenRecJP1XC3;
        TH1D *hpairGenRecJP1XC4;
        TH1D *hpairGenRecJP1XC5;
        TH1D *hpairGenRecJP2XC2;
        TH1D *hpairGenRecJP2XC3;
        TH1D *hpairGenRecJP2XC4;
        TH1D *hpairGenRecJP2XC5;
