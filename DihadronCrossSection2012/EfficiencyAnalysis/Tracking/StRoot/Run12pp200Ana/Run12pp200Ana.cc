...
void Run12pp200Ana::Loop()
{
	...
	hpairGenRecJP2XC2 = new TH1D("hGenRecJP2XC2", "", xnBins, xnBinsEdges);
	hpairGenRecJP2XC3 = new TH1D("hGenRecJP2XC3", "", xnBins, xnBinsEdges);
	hpairGenRecJP2XC4 = new TH1D("hGenRecJP2XC4", "", xnBins, xnBinsEdges);
	hpairGenRecJP2XC5 = new TH1D("hGenRecJP2XC5", "", xnBins, xnBinsEdges);

	hpairGenRecJP1XC2 = new TH1D("hGenRecJP1XC2", "", xnBins, xnBinsEdges);
	hpairGenRecJP1XC3 = new TH1D("hGenRecJP1XC3", "", xnBins, xnBinsEdges);
	hpairGenRecJP1XC4 = new TH1D("hGenRecJP1XC4", "", xnBins, xnBinsEdges);
	hpairGenRecJP1XC5 = new TH1D("hGenRecJP1XC5", "", xnBins, xnBinsEdges);

	hpairGenRecJP0XC2 = new TH1D("hGenRecJP0XC2", "", xnBins, xnBinsEdges);
	hpairGenRecJP0XC3 = new TH1D("hGenRecJP0XC3", "", xnBins, xnBinsEdges);
	hpairGenRecJP0XC4 = new TH1D("hGenRecJP0XC4", "", xnBins, xnBinsEdges);
	hpairGenRecJP0XC5 = new TH1D("hGenRecJP0XC5", "", xnBins, xnBinsEdges);
	// with x-sec level cut
	hGenRecJP0NegX = new TH1D("hGenRecJP0NegX", "", xnBins, xnBinsEdges);
	hGenJP0NegX = new TH1D("hGenJP0NegX", "", xnBins, xnBinsEdges);

	hGenRecJP1NegX = new TH1D("hGenRecJP1NegX", "", xnBins, xnBinsEdges);
	hGenJP1NegX = new TH1D("hGenJP1NegX", "", xnBins, xnBinsEdges);

	hGenRecJP2NegX = new TH1D("hGenRecJP2NegX", "", xnBins, xnBinsEdges);
	hGenJP2NegX = new TH1D("hGenJP2NegX", "", xnBins, xnBinsEdges);

	hGenRecJP0PosX = new TH1D("hGenRecJP0PosX", "", xnBins, xnBinsEdges);
	hGenJP0PosX = new TH1D("hGenJP0PosX", "", xnBins, xnBinsEdges);

	hGenRecJP1PosX = new TH1D("hGenRecJP1PosX", "", xnBins, xnBinsEdges);
	hGenJP1PosX = new TH1D("hGenJP1PosX", "", xnBins, xnBinsEdges);

	hGenRecJP2PosX = new TH1D("hGenRecJP2PosX", "", xnBins, xnBinsEdges);
	hGenJP2PosX = new TH1D("hGenJP2PosX", "", xnBins, xnBinsEdges);
	// with loose gen cut
	hGenRecJP0Neg = new TH1D("hGenRecJP0Neg", "", xnBins, xnBinsEdges);
	hGenJP0Neg = new TH1D("hGenJP0Neg", "", xnBins, xnBinsEdges);

	hGenRecJP1Neg = new TH1D("hGenRecJP1Neg", "", xnBins, xnBinsEdges);
	hGenJP1Neg = new TH1D("hGenJP1Neg", "", xnBins, xnBinsEdges);

	hGenRecJP2Neg = new TH1D("hGenRecJP2Neg", "", xnBins, xnBinsEdges);
	hGenJP2Neg = new TH1D("hGenJP2Neg", "", xnBins, xnBinsEdges);

	hGenRecJP0Pos = new TH1D("hGenRecJP0Pos", "", xnBins, xnBinsEdges);
	hGenJP0Pos = new TH1D("hGenJP0Pos", "", xnBins, xnBinsEdges);

	hGenRecJP1Pos = new TH1D("hGenRecJP1Pos", "", xnBins, xnBinsEdges);
	hGenJP1Pos = new TH1D("hGenJP1Pos", "", xnBins, xnBinsEdges);

	hGenRecJP2Pos = new TH1D("hGenRecJP2Pos", "", xnBins, xnBinsEdges);
	hGenJP2Pos = new TH1D("hGenJP2Pos", "", xnBins, xnBinsEdges);
	// pair level
	hpairGenJP0X = new TH1D("hpairGenJP0X", "", xnBins, xnBinsEdges);
	hpairGenRecJP0X = new TH1D("hpairGenRecJP0X", "", xnBins, xnBinsEdges);

	hpairGenJP1X = new TH1D("hpairGenJP1X", "", xnBins, xnBinsEdges);
	hpairGenRecJP1X = new TH1D("hpairGenRecJP1X", "", xnBins, xnBinsEdges);

	hpairGenJP2X = new TH1D("hpairGenJP2X", "", xnBins, xnBinsEdges);
	hpairGenRecJP2X = new TH1D("hpairGenRecJP2X", "", xnBins, xnBinsEdges);

	hpairGenJP0 = new TH1D("hpairGenJP0", "", xnBins, xnBinsEdges);
	hpairGenRecJP0 = new TH1D("hpairGenRecJP0", "", xnBins, xnBinsEdges);

	hpairGenJP1 = new TH1D("hpairGenJP1", "", xnBins, xnBinsEdges);
	hpairGenRecJP1 = new TH1D("hpairGenRecJP1", "", xnBins, xnBinsEdges);

	hpairGenJP2 = new TH1D("hpairGenJP2", "", xnBins, xnBinsEdges);
	hpairGenRecJP2 = new TH1D("hpairGenRecJP2", "", xnBins, xnBinsEdges);
					...
					if (isJP0)
					{
						...
						for (int i = 0; i < xnBins; i++)
						{
							if (Minv_mc >= xnBinsEdges[i] && Minv_mc < xnBinsEdges[i + 1])
							{
								...
								hpairGenJP0->Fill(Minv_mc, ptw);
								if (pipos_gen_rec && pineg_gen_rec)
									hpairGenRecJP0->Fill(Minv_mc, ptw);

								// track level efficiency
								//  fill positive pion eta
								hGenJP0Pos->Fill(Minv_mc, ptw);
								// fill negative pion eta
								hGenJP0Neg->Fill(Minv_mc, ptw);

								// fill generated and reconstructed
								if (pipos_gen_rec)
									hGenRecJP0Pos->Fill(Minv_mc, ptw);
								if (pineg_gen_rec)
									hGenRecJP0Neg->Fill(Minv_mc, ptw);

								if (tr1_genX && tr2_genX) // selects generated pair with same fiducial cut as rec.
								{
									// pair level efficieicy
									hpairGenJP0X->Fill(Minv_mc, ptw);
									if (pipos_gen_recX && pineg_gen_recX)
									{
										hpairGenRecJP0X->Fill(Minv_mc, ptw);
										if (cone > 0.02)
											hpairGenRecJP0XC2->Fill(Minv_mc, ptw);
										if (cone > 0.03)
											hpairGenRecJP0XC3->Fill(Minv_mc, ptw);
										if (cone > 0.04)
											hpairGenRecJP0XC4->Fill(Minv_mc, ptw);
										if (cone > 0.05)
											hpairGenRecJP0XC5->Fill(Minv_mc, ptw);
									}
									// fill positive pion eta
									hGenJP0PosX->Fill(Minv_mc, ptw);
									// fill negative pion eta
									hGenJP0NegX->Fill(Minv_mc, ptw);
									// fill generated and reconstructed
									if (pipos_gen_recX)
										hGenRecJP0PosX->Fill(Minv_mc, ptw);
									if (pineg_gen_recX)
										hGenRecJP0NegX->Fill(Minv_mc, ptw);
								}
							}
						}
					} // jp0 selection ends
					if (isJP1)
					{
						...
						for (int i = 0; i < xnBins; i++)
						{
							if (Minv_mc >= xnBinsEdges[i] && Minv_mc < xnBinsEdges[i + 1])
							{
								...
								// pair level efficieicy
								hpairGenJP1->Fill(Minv_mc, ptw);
								if (pipos_gen_rec && pineg_gen_rec)
									hpairGenRecJP1->Fill(Minv_mc, ptw);

								// track level efficiency
								//  fill positive pion eta
								hGenJP1Pos->Fill(Minv_mc, ptw);
								// fill negative pion eta
								hGenJP1Neg->Fill(Minv_mc, ptw);

								// fill generated and reconstructed
								if (pipos_gen_rec)
									hGenRecJP1Pos->Fill(Minv_mc, ptw);
								if (pineg_gen_rec)
									hGenRecJP1Neg->Fill(Minv_mc, ptw);

								if (tr1_genX && tr2_genX) // selects generated pair with same fiducial cut as rec.
								{
									// pair level efficieicy
									hpairGenJP1X->Fill(Minv_mc, ptw);
									if (pipos_gen_recX && pineg_gen_recX)
									{
										hpairGenRecJP1X->Fill(Minv_mc, ptw);

										if (cone > 0.02)
											hpairGenRecJP1XC2->Fill(Minv_mc, ptw);
										if (cone > 0.03)
											hpairGenRecJP1XC3->Fill(Minv_mc, ptw);
										if (cone > 0.04)
											hpairGenRecJP1XC4->Fill(Minv_mc, ptw);
										if (cone > 0.05)
											hpairGenRecJP1XC5->Fill(Minv_mc, ptw);
									}

									// fill positive pion eta
									hGenJP1PosX->Fill(Minv_mc, ptw);
									// fill negative pion eta
									hGenJP1NegX->Fill(Minv_mc, ptw);
									// fill generated and reconstructed
									if (pipos_gen_recX)
										hGenRecJP1PosX->Fill(Minv_mc, ptw);
									if (pineg_gen_recX)
										hGenRecJP1NegX->Fill(Minv_mc, ptw);
								}
							}
						}
					}
					if (isJP2)
					{
						...
						for (int i = 0; i < xnBins; i++)
						{
							if (Minv_mc >= xnBinsEdges[i] && Minv_mc < xnBinsEdges[i + 1])
							{
								...
								// pair level efficieicy
								hpairGenJP2->Fill(Minv_mc, ptw);
								if (pipos_gen_rec && pineg_gen_rec)
									hpairGenRecJP2->Fill(Minv_mc, ptw);

								// track level efficiency
								//  fill positive pion eta
								hGenJP2Pos->Fill(Minv_mc, ptw);
								// fill negative pion eta
								hGenJP2Neg->Fill(Minv_mc, ptw);

								// fill generated and reconstructed
								if (pipos_gen_rec)
									hGenRecJP2Pos->Fill(Minv_mc, ptw);
								if (pineg_gen_rec)
									hGenRecJP2Neg->Fill(Minv_mc, ptw);

								if (tr1_genX && tr2_genX) // selects generated pair with same fiducial cut as rec.
								{
									// pair level efficieicy
									hpairGenJP2X->Fill(Minv_mc, ptw);
									if (pipos_gen_recX && pineg_gen_recX)
									{
										hpairGenRecJP2X->Fill(Minv_mc, ptw);
										if (cone > 0.02)
											hpairGenRecJP2XC2->Fill(Minv_mc, ptw);
										if (cone > 0.03)
											hpairGenRecJP2XC3->Fill(Minv_mc, ptw);
										if (cone > 0.04)
											hpairGenRecJP2XC4->Fill(Minv_mc, ptw);
										if (cone > 0.05)
											hpairGenRecJP2XC5->Fill(Minv_mc, ptw);
									}
									// fill positive pion eta
									hGenJP2PosX->Fill(Minv_mc, ptw);
									// fill negative pion eta
									hGenJP2NegX->Fill(Minv_mc, ptw);
									// fill generated and reconstructed
									if (pipos_gen_recX)
										hGenRecJP2PosX->Fill(Minv_mc, ptw);
									if (pineg_gen_recX)
										hGenRecJP2NegX->Fill(Minv_mc, ptw);
								}
							}
						}
					}
...
void Run12pp200Ana::Finish(char *ofile)
{
	...
	hGenJP0NegX->Write();
	hGenRecJP0NegX->Write();
	hGenJP1NegX->Write();
	hGenRecJP1NegX->Write();
	hGenJP2NegX->Write();
	hGenRecJP2NegX->Write();

	hGenJP0PosX->Write();
	hGenRecJP0PosX->Write();
	hGenJP1PosX->Write();
	hGenRecJP1PosX->Write();
	hGenJP2PosX->Write();
	hGenRecJP2PosX->Write();
	...
	hpairGenJP0->Write();
	hpairGenRecJP0->Write();
	hpairGenJP1->Write();
	hpairGenRecJP1->Write();
	hpairGenJP2->Write();
	hpairGenRecJP2->Write();

	hpairGenJP0X->Write();
	hpairGenRecJP0X->Write();
	hpairGenJP1X->Write();
	hpairGenRecJP1X->Write();
	hpairGenJP2X->Write();
	hpairGenRecJP2X->Write();
	...
	hpairGenRecJP0XC2->Write();
	hpairGenRecJP0XC3->Write();
	hpairGenRecJP0XC4->Write();
	hpairGenRecJP0XC5->Write();

	hpairGenRecJP1XC2->Write();
	hpairGenRecJP1XC3->Write();
	hpairGenRecJP1XC4->Write();
	hpairGenRecJP1XC5->Write();

	hpairGenRecJP2XC2->Write();
	hpairGenRecJP2XC3->Write();
	hpairGenRecJP2XC4->Write();
	hpairGenRecJP2XC5->Write();
