...
void xsecAnaMinConeCut()
{
    ...
    TFile *fxout = new TFile("ResultsMinConeCut/fxsecOutput.root", "Recreate");
    ...
    TFile *funfolding = new TFile("../BinResolutionAndUnfolding/UnfoldingResultsMinConeCut/unfoldingOutput.root", "r");
    ...
    ofstream fxsec0;
    fxsec0.open("ResultsMinConeCut/fxsec_jp0_numbers.tex");
    fxsec0 << "\%Cross section results for jp0 " << endl;

    ofstream fxsec1;
    fxsec1.open("ResultsMinConeCut/fxsec_jp1_numbers.tex");
    fxsec1 << "\%Cross section results for jp1" << endl;

    ofstream fxsec2;
    fxsec2.open("ResultsMinConeCut/fxsec_jp2_numbers.tex");
    fxsec2 << "\%Cross section results for jp2" << endl;

    ofstream fxsec;
    fxsec.open("ResultsMinConeCut/fxsec_values.tex");
    fxsec << "% 1. Bin Range 2. Xsec 3. StatErr 4. Xsec_Pyth 5. Pyth_Err 6. TrgEffErr  7. SysPID 8. Sys_TrgBias 9. Sys_Total " << endl;

    ofstream fsyserr;
    fsyserr.open("ResultsMinConeCut/syserr_numbers.tex");
    ...
    cmpt->SaveAs("ResultsMinConeCut/xsec_MoneyPlot.png");
    cmpt->SaveAs("ResultsMinConeCut/xsec_MoneyPlot.eps");
    delete cmpt;
