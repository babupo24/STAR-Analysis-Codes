...
public:
        ...
        virtual void matchFinder(double, double, double, double, int, int[], double[], double[], double[], double[], double &, double &, double &, double &, double &, double &, double &, double &, double &, int &);
