...
void Run12pp200Ana(const char *ifile = "/star/u/pokhrel/GPFS/Run12EmbeddingTrees/NewBatch/tree_13047003.root", const char *ofile = "testEmbedHist.root") // interactive mode
{
