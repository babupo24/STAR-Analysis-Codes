...
void get_fraction_JP0()
{
    ...
    const TH1D *htrueKE_JP0 = (TH1D *)fin->Get("htrueKaonElectronPairJP0");
    const TH1D *htrueKK_JP0 = (TH1D *)fin->Get("htrueKaonPairJP0");
    const TH1D *htruePP_JP0 = (TH1D *)fin->Get("htrueProtonPairJP0");
    const TH1D *htruePE_JP0 = (TH1D *)fin->Get("htrueProtonElectronPairJP0");
    const TH1D *htruePK_JP0 = (TH1D *)fin->Get("htrueProtonKaonPairJP0");
    const TH1D *htruePiE_JP0 = (TH1D *)fin->Get("htruePionElectronPairJP0");
    const TH1D *htruePiK_JP0 = (TH1D *)fin->Get("htruePionKaonPairJP0");
    const TH1D *htruePiP_JP0 = (TH1D *)fin->Get("htruePionProtonPairJP0");
    const TH1D *htruePi_JP0 = (TH1D *)fin->Get("htruePionPairJP0"); // det and true
    const TH1D *hrecPi_JP0 = (TH1D *)fin->Get("hrecPionPairJP0");   // only detector pid

    TH1D *hdeno = (TH1D *)hrecPi_JP0->Clone();
    TH1D *hfPiPi = (TH1D *)htruePi_JP0->Clone();
    hfPiPi->Divide(hdeno);
    TH1D *hfPiP = (TH1D *)htruePiP_JP0->Clone();
    hfPiP->Divide(hdeno);
    TH1D *hfPiK = (TH1D *)htruePiK_JP0->Clone();
    hfPiK->Divide(hdeno);
    TH1D *hfPiE = (TH1D *)htruePiE_JP0->Clone();
    hfPiE->Divide(hdeno);
    TH1D *hfPE = (TH1D *)htruePE_JP0->Clone();
    hfPE->Divide(hdeno);
    TH1D *hfPK = (TH1D *)htruePK_JP0->Clone();
    hfPK->Divide(hdeno);
    TH1D *hfPP = (TH1D *)htruePP_JP0->Clone();
    hfPP->Divide(hdeno);
    TH1D *hfKK = (TH1D *)htrueKK_JP0->Clone();
    hfKK->Divide(hdeno);
    TH1D *hfKE = (TH1D *)htrueKE_JP0->Clone();
    hfKE->Divide(hdeno);
    ...
    can->Update();
    can->SaveAs("Plots/fractions_JP0.pdf");

    ofstream fout;
    fout.open("Plots/fractions_JP0.txt");
