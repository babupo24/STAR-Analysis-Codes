...
void get_fraction_JP2()
{
    ...
    const TH1D *htrueKE_JP2 = (TH1D *)fin->Get("htrueKaonElectronPairJP2");
    const TH1D *htrueKK_JP2 = (TH1D *)fin->Get("htrueKaonPairJP2");
    const TH1D *htruePP_JP2 = (TH1D *)fin->Get("htrueProtonPairJP2");
    const TH1D *htruePE_JP2 = (TH1D *)fin->Get("htrueProtonElectronPairJP2");
    const TH1D *htruePK_JP2 = (TH1D *)fin->Get("htrueProtonKaonPairJP2");
    const TH1D *htruePiE_JP2 = (TH1D *)fin->Get("htruePionElectronPairJP2");
    const TH1D *htruePiK_JP2 = (TH1D *)fin->Get("htruePionKaonPairJP2");
    const TH1D *htruePiP_JP2 = (TH1D *)fin->Get("htruePionProtonPairJP2");
    const TH1D *htruePi_JP2 = (TH1D *)fin->Get("htruePionPairJP2"); // det and true
    const TH1D *hrecPi_JP2 = (TH1D *)fin->Get("hrecPionPairJP2");   // only detector pid

    TH1D *hdeno = (TH1D *)hrecPi_JP2->Clone();
    TH1D *hfPiPi = (TH1D *)htruePi_JP2->Clone();
    hfPiPi->Divide(hdeno);
    TH1D *hfPiP = (TH1D *)htruePiP_JP2->Clone();
    hfPiP->Divide(hdeno);
    TH1D *hfPiK = (TH1D *)htruePiK_JP2->Clone();
    hfPiK->Divide(hdeno);
    TH1D *hfPiE = (TH1D *)htruePiE_JP2->Clone();
    hfPiE->Divide(hdeno);
    TH1D *hfPE = (TH1D *)htruePE_JP2->Clone();
    hfPE->Divide(hdeno);
    TH1D *hfPK = (TH1D *)htruePK_JP2->Clone();
    hfPK->Divide(hdeno);
    TH1D *hfPP = (TH1D *)htruePP_JP2->Clone();
    hfPP->Divide(hdeno);
    TH1D *hfKK = (TH1D *)htrueKK_JP2->Clone();
    hfKK->Divide(hdeno);
    TH1D *hfKE = (TH1D *)htrueKE_JP2->Clone();
    hfKE->Divide(hdeno);
    ...
    can->Update();
    can->SaveAs("Plots/fractions_JP2.pdf");

    ofstream fout;
    fout.open("Plots/fractions_JP2.txt");
