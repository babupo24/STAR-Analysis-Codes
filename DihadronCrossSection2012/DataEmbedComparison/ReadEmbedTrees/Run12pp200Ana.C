class Run12pp200Ana;
 ...
 //void Run12pp200Ana(const char *ifile = "/star/u/pokhrel/GPFS/Run12EmbeddingTrees/NewBatch3/tree_13047003.root", const char *ofile = "testEmbed.root") // interactive mode
 void Run12pp200Ana(const char *ifile = "/star/u/pokhrel/GPFS/Run12EmbeddingTrees/tree_13047*.root", const char *ofile = "testEmbed.root") // interactive mode
{
